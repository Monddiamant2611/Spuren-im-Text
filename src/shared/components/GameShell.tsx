...
import { dramaGlossary } from "../../games/dramatik/data/glossary";
import { GlossaryCards } from "../../games/dramatik/components/GlossaryCards";

type Overlay = "options" | "sources" | "regiebuch" | "terms" | "chapter" | null;
    ...
    <main className={`game-shell theatre-${state.theatreState.toLowerCase()} ${state.settings.reducedMotion ? "reduce-motion" : ""}`}>
      <header className="game-header">
        ...
        <nav className="utility-nav" aria-label="Spielmenü">
          ...
          <button onClick={() => setOverlay("terms")}>Begriffskarten</button>
