...
export const dramaGlossary:readonly GlossaryEntry[]=[
 ...
 {id:"conditions",term:"Bedingungen",definition:"Bedingungen sind äußere Umstände, die eine Situation beeinflussen, etwa Regeln, Erwartungen oder Machtverhältnisse.",chapter:"chapter_01"},
 ...
 {id:"effect",term:"Wirkung",definition:"Die Wirkung beschreibt, welchen Eindruck ein sprachliches oder szenisches Mittel im konkreten Zusammenhang hervorruft.",chapter:"chapter_03"},
 {id:"function",term:"Funktion",definition:"Die Funktion bezeichnet die Aufgabe, die ein Textsignal, eine Äußerung oder Bühnenhandlung für Gespräch, Konflikt oder Szenenverlauf erfüllt.",chapter:"chapter_03"},
 ...
 {id:"cause",term:"Ursache",definition:"Eine Ursache löst einen bestimmten Handlungsschritt oder eine Veränderung unmittelbar aus.",chapter:"chapter_04"},
 {id:"consequence",term:"Folge",definition:"Eine Folge ist eine Veränderung, die aus einer vorausgehenden Handlung, Entscheidung oder Entwicklung hervorgeht.",chapter:"chapter_04"},
 {id:"knowledge_state",term:"Wissensstand",definition:"Der Wissensstand umfasst, was eine Figur in einer bestimmten Situation weiß, nicht weiß oder nur vermutet.",chapter:"chapter_04"},
 ...
 {id:"text_evidence",term:"Textbeleg",definition:"Eine konkrete Textstelle, die eine Beobachtung oder Deutung nachprüfbar stützt.",chapter:"chapter_05"},
 ...
 {id:"argumentation",term:"Argumentation",definition:"Eine Argumentation verbindet Behauptung, passenden Textbeleg und erklärende Analyse zu einem nachvollziehbaren Deutungsschritt.",chapter:"chapter_05"},
 {id:"hypothesis_link",term:"Rückbindung",definition:"Die Rückbindung erklärt ausdrücklich, wie ein Analyseergebnis die Deutungshypothese stützt, präzisiert oder einschränkt.",chapter:"chapter_05"},
];
