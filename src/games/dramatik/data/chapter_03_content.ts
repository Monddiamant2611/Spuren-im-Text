...
export const practiceActs=[
 {id:"practice_mara_stop",line:0,act:"auffordern",goal:"Leon am Gehen hindern"},
 {id:"practice_leon_reject",line:1,act:"zurückweisen",goal:"eine Erklärung vermeiden"},
 {id:"practice_mara_look",line:2,act:"auffordern",goal:"Leons Aufmerksamkeit auf das Gespräch lenken"},
 {id:"practice_leon_leave",line:3,act:"auffordern",goal:"die Situation verlassen"},
] as const;
...
export const speechTasks=[
 {id:"act_mercutio",sourceId:"c03_main_mercutio_provoke",act:"provozieren",reactionId:"c03_main_benvolio_public",effect:"Benvolio versucht, die Auseinandersetzung aus der Öffentlichkeit zu verlagern."},
 {id:"act_tybalt",sourceId:"c03_main_tybalt_challenge",act:"herausfordern",reactionId:"c03_main_romeo_reassure",effect:"Romeo weist die Beleidigung zurück und versucht erneut zu beruhigen."},
 {id:"act_romeo",sourceId:"c03_main_romeo_stop",act:"auffordern",reactionId:"c03_main_fight",effect:"Die Aufforderung stoppt die körperliche Auseinandersetzung nicht."},
] as const;
