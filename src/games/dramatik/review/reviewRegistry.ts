...
export const reviewTargets:ReviewTarget[]=[
 ...
 ...chapter("chapter_04",["Konfliktinformationen","Äußerer und innerer Konflikt","Zeitliche und kausale Folge","Dramatische Handlung entwickelt sich","Allgemeine Handlungskurve","Handlung – Reaktion – Folge","Wendepunkt allgemein","Romeo/Paris: Ausgangslage","Wissensstände","Ziele und Belege","Handlungskette","Kausalität","Handlung – Reaktion – Veränderung","Eskalation und Wendepunkt","Innerer Konflikt vorbereiten","Juliettes Situation und Text","Juliettes Konfliktstruktur","Abwägung bis zur Ausführung","Entscheidung und Ausführung","Handlungsalternativen","Konflikte vergleichen","Abschlussrekonstruktion","Kapitelabschluss"]),
