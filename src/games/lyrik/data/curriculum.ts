...
export const curriculum:readonly CurriculumChapter[]=[
 ...
 {id:"form",number:3,title:"Form und Aufbau",goals:["Verse, Strophen und Verslängen untersuchen","Reim, Reimschema, Enjambement und Endstopp erkennen","Symmetrien, Brüche und Relevanz gewichten"]},
 {id:"speaker",number:4,title:"Sprechsituation und lyrisches Ich",goals:["Autor und Sprecher trennen","Adressat und Sprechsituation bestimmen","Wissen und Perspektive begrenzen"],authenticApplication:"Joseph von Eichendorff: Sehnsucht (1834) – Sprecher- und Sehnsuchtssituation"},
 ...
 {id:"mood",number:8,title:"Stimmung, Haltung und Perspektive",goals:["die drei Begriffe unterscheiden","Stimmung aus mehreren Signalen erschließen","Haltung und Perspektivwechsel textnah begrenzen"],authenticApplication:"Joseph von Eichendorff: Sehnsucht (1834) – Stimmung und Perspektive"},
